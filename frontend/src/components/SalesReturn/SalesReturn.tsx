...
const SalesReturn: React.FC<SalesReturnProps> = ({ isOpen, onClose }) => {
  const { medicines, suppliers, purchases, addStockTransaction, updateMedicine, addBill, showSuccess, showError } = useApp();
